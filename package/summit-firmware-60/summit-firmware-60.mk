...
SUMMIT_FIRMWARE_60_SOURCE =
SUMMIT_FIRMWARE_60_LICENSE = Ezurio
SUMMIT_FIRMWARE_60_LICENSE_FILES = COPYING
...
SUMMIT_FIRMWARE_60_EXTRA_DOWNLOADS += summit-som8mp-radio-firmware-$(SUMMIT_FIRMWARE_60_VERSION).tar.bz2
endif

SUMMIT_FIRMWARE_60_EXTRA_DOWNLOADS += $(foreach n,$(SUMMIT_FIRMWARE_60_PKGS),summit-60-radio-firmware-$(n)-$(SUMMIT_FIRMWARE_60_VERSION).tar.bz2)

define SUMMIT_FIRMWARE_60_INSTALL_TARGET_CMDS
	$(foreach n,$(SUMMIT_FIRMWARE_60_EXTRA_DOWNLOADS),tar -xjf $($(PKG)_DL_DIR)/$(n) -C $(TARGET_DIR) --keep-directory-symlink --no-overwrite-dir --touch $(sep))
endef
