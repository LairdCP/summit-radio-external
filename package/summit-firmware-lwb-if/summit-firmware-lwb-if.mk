...
ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_LWB_IF_IF513_DIV),y)
SUMMIT_FIRMWARE_LWB_IF_IF513_PKGS += div
endif

ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_LWB_IF_IF513_SA),y)
SUMMIT_FIRMWARE_LWB_IF_IF513_PKGS += sa
endif

SUMMIT_FIRMWARE_LWB_IF_DOWNLOADS += $(foreach n,$(SUMMIT_FIRMWARE_LWB_IF_IF513_PKGS),summit-if513-sdio-$(n)-firmware-$(SUMMIT_FIRMWARE_LWB_IF_VERSION).tar.bz2)
