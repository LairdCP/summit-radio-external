...
SUMMIT_FIRMWARE_LWB_IF_EXTRA_DOWNLOADS += $(foreach n,$(SUMMIT_FIRMWARE_LWB_IF_LWB_PKGS),summit-lwb-$(n)-firmware-$(SUMMIT_FIRMWARE_LWB_IF_VERSION).tar.bz2)
...
SUMMIT_FIRMWARE_LWB_IF_EXTRA_DOWNLOADS += $(foreach n,$(SUMMIT_FIRMWARE_LWB_IF_LWB5_PKGS),summit-lwb5-$(n)-firmware-$(SUMMIT_FIRMWARE_LWB_IF_VERSION).tar.bz2)
...
SUMMIT_FIRMWARE_LWB_IF_EXTRA_DOWNLOADS += $(foreach n,$(SUMMIT_FIRMWARE_LWB_IF_LWB5PLUS_PKGS),summit-lwb5plus-$(n)-firmware-$(SUMMIT_FIRMWARE_LWB_IF_VERSION).tar.bz2)

ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_LWB_IF_LWBPLUS),y)
SUMMIT_FIRMWARE_LWB_IF_EXTRA_DOWNLOADS += summit-lwbplus-firmware-$(SUMMIT_FIRMWARE_LWB_IF_VERSION).tar.bz2
endif
...
SUMMIT_FIRMWARE_LWB_IF_EXTRA_DOWNLOADS += $(foreach n,$(SUMMIT_FIRMWARE_LWB_IF_IF573_PKGS),summit-if573-$(n)-firmware-$(SUMMIT_FIRMWARE_LWB_IF_VERSION).tar.bz2)

ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_LWB_IF_IF513),y)
SUMMIT_FIRMWARE_LWB_IF_EXTRA_DOWNLOADS += summit-if513-firmware-$(SUMMIT_FIRMWARE_LWB_IF_VERSION).tar.bz2
endif
