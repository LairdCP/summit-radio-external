...
SUMMIT_HOSTAPD_SITE = $(SUMMIT_RADIO_URI_BASE_INTERNAL)/summit_hostapd/laird/$(SUMMIT_HOSTAPD_VERSION)
endif

SUMMIT_HOSTAPD_SOURCE = summit_hostapd-src-$(SUMMIT_HOSTAPD_VERSION).tar.gz
