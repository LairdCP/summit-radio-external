...
SUMMIT_FIRMWARE_EXTRA_DOWNLOADS += summit-ath6k-6003-firmware-$(SUMMIT_FIRMWARE_VERSION).tar.bz2
endif

ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_MSD_50),y)
SUMMIT_FIRMWARE_EXTRA_DOWNLOADS += summit-ath6k-6004-firmware-$(SUMMIT_FIRMWARE_VERSION).tar.bz2
endif
