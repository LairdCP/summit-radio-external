...
SUMMIT_SUPPLICANT_LIBS_STRIP_COMPONENTS = 0
...
ifeq ($(BR2_PACKAGE_SUMMIT_SUPPLICANT_LIBS_LEGACY),y)
define SUMMIT_SUPPLICANT_LIBS_LEGACY_INSTALL_TARGET_CMDS
...
define SUMMIT_SUPPLICANT_LIBS_LEGACY_INSTALL_STAGING_CMDS
	$(INSTALL) -D -m 0644 -t $(STAGING_DIR)/usr/include $(@D)/usr/include/*
endef
endif

define SUMMIT_SUPPLICANT_LIBS_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0644 -t $(TARGET_DIR)/usr/lib $(@D)/usr/lib/*
	$(SUMMIT_SUPPLICANT_LIBS_LEGACY_INSTALL_TARGET_CMDS)
endef

define SUMMIT_SUPPLICANT_LIBS_INSTALL_STAGING_CMDS
	$(INSTALL) -D -m 0644 -t $(STAGING_DIR)/usr/lib $(@D)/usr/lib/*
