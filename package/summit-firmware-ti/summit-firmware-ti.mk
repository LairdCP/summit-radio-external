...
SUMMIT_FIRMWARE_TI_LICENSE_FILES = LICENSE.ezurio
...
ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
  ...
  SUMMIT_FIRMWARE_TI_VERSION = 0.$(BR2_SUMMIT_BRANCH).0.0
  BR_NO_CHECK_HASH_FOR += $(SUMMIT_FIRMWARE_TI_DOWNLOADS)
  SUMMIT_FIRMWARE_TI_SITE = file://$(BASE_DIR)/../firmware/images
else
