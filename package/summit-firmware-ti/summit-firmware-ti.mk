...
ifeq ($(MSD_60_SOURCE_LOCATION),laird_internal)
  ...
  SUMMIT_FIRMWARE_TI_SITE = https://github.com/LairdCP/SonaTI-Release-Packages/releases/tag/LRD-REL-$(SUMMIT_FIRMWARE_TI_VERSION)
endif

ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_TI_351),y)
SUMMIT_FIRMWARE_TI_EXTRA_DOWNLOADS += laird-ti351-firmware-$(SUMMIT_FIRMWARE_TI_VERSION).tar.bz2
endif
