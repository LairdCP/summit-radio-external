...
ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
  ...
  SUMMIT_REG50N_VERSION = 0.$(BR2_SUMMIT_BRANCH).0.0
  BR_NO_CHECK_HASH_FOR += $(SUMMIT_REG50N_SOURCE)
  SUMMIT_REG50N_SITE = file://$(BASE_DIR)/../reg50n-$(SUMMIT_RADIO_STACK_ARCH)/images
else
